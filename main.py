...
def preemptive_fifo(processes):
    ...
    print("===================================")
    print("Process Name\tArrival Time\tClock Cycle\tTurnaround Time\tWaiting Time")
    for i in processes:
        print(i.name + "\t\t" + str(i.arrival_time) + "\t\t" + str(i.clock_cycle) + "\t\t" + str(i.turnaround_time) + "\t\t" + str(i.waiting_time))
